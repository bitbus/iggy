...
mod tests {
    ...
    fn create_test_indices(segment: &mut Segment) {
        let indexes = vec![
            Index { relative_offset: 5, position: 0 },
            Index { relative_offset: 20, position: 100 },
            Index { relative_offset: 35, position: 200 },
            Index { relative_offset: 50, position: 300 },
            Index { relative_offset: 65, position: 400 },
        ];
